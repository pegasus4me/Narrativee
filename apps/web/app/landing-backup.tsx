...
export default function LandingBackup() {
  return (
    <div className="flex flex-col items-center justify-center font-[family-name:var(--font-urbanist)] overflow-x-hidden">
      <div className="w-full max-w-[1440px] mx-auto mb-[30px] sm:mb-[80px]">
      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8 py-10 md:py-6">
        ...
        <div className="flex flex-col gap-8 md:w-5/12">
          {/* Heading */}
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-zinc-900 relative">
        ...
        <div className="relative w-full md:w-7/12 flex justify-center items-center">
          <div className="relative w-full scale-110 md:scale-125 origin-center">
             <Image 
                ...
                width={1500} 
                height={1300} 
                className="w-full h-auto object-contain border border-neutral-200 rounded-lg"
                priority
             />
          </div>
        </div>
