        ...
        <div className="rounded-3xl border border-white/10 bg-zinc-950/70 p-6 shadow-[0_20px_80px_rgba(0,0,0,0.35)] flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="max-w-2xl space-y-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-indigo-400">Library Engine</p>
            </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 text-xs font-bold text-white transition-all hover:bg-indigo-500 shadow-md shadow-indigo-600/10 cursor-pointer"
          >
          ...
          <button
            ...
            className={`px-4 py-2 text-xs font-bold rounded-xl border transition-all ${
              selectedPlatform === "all"
                ? "bg-zinc-100 text-zinc-950 border-white/10"
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="rounded-full border border-white/5 bg-white/[0.02] px-2.5 py-0.5 text-[9px] font-bold text-zinc-400 uppercase tracking-wide">
                            {hook.category}
                          </span>
                        </div>
                        {hook.isCustom && (
          ...
          <div className="w-full max-w-lg rounded-2xl border border-white/10 bg-[#09090b] p-6 shadow-2xl space-y-5 animate-in zoom-in-95 duration-150 text-zinc-150">
            ...
            <form onSubmit={handleAddHook} className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-white/5">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 text-xs font-bold rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white transition-all cursor-pointer"
                >
                  Save Hook
                </button>
              </div>
