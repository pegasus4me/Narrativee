      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 bg-white relative">
        <div className="w-full max-w-[440px]">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h3 className='text-gray-500 text-sm mt-2'>Get started for free. No credit card required.</h3>
          </div>
          ...
          <div className="">
            ...
            <form onSubmit={handleEmailSignUp} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-[13px] font-medium text-gray-700 ml-1">Name</label>
                <input
                  type="text"
                  required
                  value={name}
