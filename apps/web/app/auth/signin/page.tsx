...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen w-full  text-white flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans antialiased">
      {/* Background Gradients to mimic Gamma's subtle glow */}
            ...
            {showPasswordField && (
              <div className="space-y-1.5">
                <div className="flex justify-between items-center ml-1">
                  ...
                  <a href="/forgot-password" className="text-[12px] text-amber-500 hover:text-amber-600 hover:underline transition-colors">Forgot?</a>
                </div>
