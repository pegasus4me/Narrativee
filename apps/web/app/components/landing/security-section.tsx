...
const securityFeatures = [
  {
    icon: Shield,
    title: "Isolated voice models",
    description: "Your custom tone clones are private and secure. We never use your writing to train public models.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Secure social OAuth",
    description: "Authorize channels like LinkedIn and X securely. We use official APIs and never store your passwords.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Review boundaries",
    description: "Maintain absolute control. Drafts are never published without your explicit manual approval.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Brand Safety",
    description: "Set constraints on forbidden topics, competitors, or phrasing to keep posts brand-safe.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["GDPR COMPLIANT", "SSL SECURED", "OFFICIAL APIS", "2FA READY"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Protected,
            <br />
            <span className="text-muted-foreground">and private.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your voice is your intellectual property. Our platform-wide privacy standards keep your data isolated and secure.
            </p>
          </div>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">Privacy & isolated training data</span>
              </div>
            </div>
