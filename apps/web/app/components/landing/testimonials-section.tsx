...
const testimonials = [
  {
    quote: "Repurposing my weekly newsletter used to take me a whole Sunday. With Narrativee, I generate a month's worth of LinkedIn posts in 10 minutes, all in my exact voice.",
    author: "Sarah Chen",
    role: "SaaS Founder & Creator",
    company: "FounderOS",
    metric: { value: "10 mins", label: "Monthly social content queue" },
  },
  {
    quote: "I was skeptical about AI cloning my tone. But Narrativee picked up my exact vocabulary, pacing, and formatting from my beehiiv archive. My readers haven't noticed a thing.",
    author: "Marcus Webb",
    role: "Growth Marketer & Writer",
    company: "The Growth Lab",
    metric: { value: "3.2x", label: "LinkedIn impression growth" },
  },
  {
    quote: "Managing three client newsletters and their social channels is a breeze now. The voice memory engine lets me switch tones instantly for each brand voice.",
    author: "Elena Rodriguez",
    role: "Newsletter Operator",
    company: "Media Craft",
    metric: { value: "5 hrs/wk", label: "Saved per client" },
  },
  {
    quote: "Our subscriber base grew by 40% after we started repurposing our Substack content to X. Narrativee's queue scheduler makes it completely set-and-forget.",
    author: "James Liu",
    role: "Tech Writer",
    company: "ByteSized Tech",
    metric: { value: "+40%", label: "Subscriber growth" },
  },
];
