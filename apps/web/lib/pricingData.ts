...
export const PricingPlans = [
    ...
    },
    {
        ...
        monthlyPrice: 29,
        annualPrice: 24,
        monthlyPriceId: isProd ? "price_starter_monthly" : "price_test_starter_monthly",
        annualPriceId: isProd ? "price_starter_annual" : "price_test_starter_annual",
        savings: 60,
        popular: true,
    ...
    },
    {
        ...
        monthlyPrice: 79,
        annualPrice: 66,
        monthlyPriceId: isProd ? "price_growth_monthly" : "price_test_growth_monthly",
        annualPriceId: isProd ? "price_growth_annual" : "price_test_growth_annual",
        savings: 156,
        popular: false,
        cta: "Start 7-day free trial",
        color: "black",
